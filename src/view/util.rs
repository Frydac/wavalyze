...
pub fn debug_rect_text(ui: &mut egui::Ui, rect: egui::Rect, color: egui::Color32, text: impl ToString) {
    let galley = ui.fonts(|f| f.layout_no_wrap(text.to_string(), egui::FontId::monospace(12.0), color));
...
pub fn debug_rect(ui: &mut egui::Ui, rect: egui::Rect, color: egui::Color32) {
    ...
    ui.painter().rect(rect, 0.0, egui::Color32::TRANSPARENT, stroke);
